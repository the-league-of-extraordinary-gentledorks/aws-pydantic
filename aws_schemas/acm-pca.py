...
ASN1PrintableString64: str = pydantic.constr(
    max_length=64, regex=r"[a-zA-Z0-9\'()+-.?:/= ]*"
)
AWSPolicy: str = pydantic.constr(
    min_length=1, max_length=20480, regex=r"[\u0009\u000A\u000D\u0020-\u00FF]+"
)
...
Arn: str = pydantic.constr(
    min_length=5,
    max_length=200,
    regex=r"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]*:[\w+=,.@-]+(/[\w+=,.@-]+)*",
)
AuditReportId: str = pydantic.constr(
    min_length=36,
    max_length=36,
...
Base64String1To4096: str = pydantic.constr(
    min_length=1,
    max_length=4096,
...
CnameString: str = pydantic.constr(
    max_length=253, regex=r"^[-a-zA-Z0-9;/?:@&=+$,%_.!~*()\']*$"
)
CountryCodeString: str = pydantic.constr(
    min_length=2, max_length=2, regex=r"[A-Za-z]{2}"
)
CsrBlob: bytes = pydantic.conbytes()
CsrBody: str = pydantic.constr()
CustomObjectIdentifier: str = pydantic.constr(
    max_length=64, regex=r"^([0-2])\.([0-9]|([0-3][0-9]))((\.([0-9]+)){0,126})$"
)
ExtendedKeyUsageType: str = pydantic.constr()
FailureReason: str = pydantic.constr()
IdempotencyToken: str = pydantic.constr(
    min_length=1, max_length=36, regex=r"[\u0009\u000A\u000D\u0020-\u00FF]*"
)
...
S3BucketName3To255: str = pydantic.constr(
    min_length=3, max_length=255, regex=r"^[-a-zA-Z0-9._/]+$"
)
...
TagValue: str = pydantic.constr(
    max_length=256, regex=r"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$"
)
...
class ASN1Subject(_ACMPCAModelBase):
    ...
    distinguished_name_qualifier: ASN1PrintableString64 = pydantic.Field(
        None, alias="DistinguishedNameQualifier"
    )
    ...
    custom_attributes: CustomAttributeList = pydantic.Field(
        None, alias="CustomAttributes"
    )
...
class AccessMethod(_ACMPCAModelBase):
    custom_object_identifier: CustomObjectIdentifier = pydantic.Field(
        None, alias="CustomObjectIdentifier"
    )
    access_method_type: AccessMethodType = pydantic.Field(
...
class CertificateAuthority(_ACMPCAModelBase):
    ...
    certificate_authority_configuration: "CertificateAuthorityConfiguration" = (
        pydantic.Field(None, alias="CertificateAuthorityConfiguration")
    )
    revocation_configuration: "RevocationConfiguration" = pydantic.Field(
        None, alias="RevocationConfiguration"
    )
    restorable_until: "TStamp" = pydantic.Field(None, alias="RestorableUntil")
    key_storage_security_standard: KeyStorageSecurityStandard = pydantic.Field(
...
class CreateCertificateAuthorityAuditReportRequest(_ACMPCAModelBase):
    ...
    audit_report_response_format: AuditReportResponseFormat = pydantic.Field(
        None, alias="AuditReportResponseFormat"
    )
...
class CreateCertificateAuthorityRequest(_ACMPCAModelBase):
    ...
    certificate_authority_type: CertificateAuthorityType = pydantic.Field(
        None, alias="CertificateAuthorityType"
    )
...
class CsrExtensions(_ACMPCAModelBase):
    ...
    subject_information_access: AccessDescriptionList = pydantic.Field(
        None, alias="SubjectInformationAccess"
    )


class CustomAttribute(_ACMPCAModelBase):
    object_identifier: CustomObjectIdentifier = pydantic.Field(
...
class DeleteCertificateAuthorityRequest(_ACMPCAModelBase):
    ...
    permanent_deletion_time_in_days: PermanentDeletionTimeInDays = pydantic.Field(
...
class DescribeCertificateAuthorityAuditReportResponse(_ACMPCAModelBase):
    audit_report_status: AuditReportStatus = pydantic.Field(
...
class DescribeCertificateAuthorityResponse(_ACMPCAModelBase):
    certificate_authority: "CertificateAuthority" = pydantic.Field(
...
class ExtendedKeyUsage(_ACMPCAModelBase):
    extended_key_usage_type: ExtendedKeyUsageType = pydantic.Field(
        None, alias="ExtendedKeyUsageType"
    )
    extended_key_usage_object_identifier: CustomObjectIdentifier = pydantic.Field(
        None, alias="ExtendedKeyUsageObjectIdentifier"
    )


class Extensions(_ACMPCAModelBase):
    certificate_policies: CertificatePolicyList = pydantic.Field(
        None, alias="CertificatePolicies"
    )
    extended_key_usage: ExtendedKeyUsageList = pydantic.Field(
        None, alias="ExtendedKeyUsage"
    )
    key_usage: "KeyUsage" = pydantic.Field(None, alias="KeyUsage")
    subject_alternative_names: GeneralNameList = pydantic.Field(
        None, alias="SubjectAlternativeNames"
    )
    custom_extensions: CustomExtensionList = pydantic.Field(
        None, alias="CustomExtensions"
    )
...
class GeneralName(_ACMPCAModelBase):
    ...
    uniform_resource_identifier: String253 = pydantic.Field(
        None, alias="UniformResourceIdentifier"
    )
...
class ListCertificateAuthoritiesResponse(_ACMPCAModelBase):
    certificate_authorities: CertificateAuthorities = pydantic.Field(
...
class PolicyInformation(_ACMPCAModelBase):
    ...
    policy_qualifiers: PolicyQualifierInfoList = pydantic.Field(
        None, alias="PolicyQualifiers"
    )


class PolicyQualifierInfo(_ACMPCAModelBase):
    policy_qualifier_id: PolicyQualifierId = pydantic.Field(
        None, alias="PolicyQualifierId"
    )
...
class RevocationConfiguration(_ACMPCAModelBase):
    crl_configuration: "CrlConfiguration" = pydantic.Field(
        None, alias="CrlConfiguration"
    )
    ocsp_configuration: "OcspConfiguration" = pydantic.Field(

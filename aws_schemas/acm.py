...
class _ACMBase(pydantic.BaseModel, frozen=True, use_enum_values=True, allow_population_by_field_name=True):
    def dict(self, by_alias=True, **kwargs) -> dict:
        return super().dict(by_alias=True, **kwargs)

Arn: str = pydantic.constr(min=20, max=2048, pattern=r'arn:[\w+=/,.@-]+:acm:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*')
AvailabilityErrorMessage: str = pydantic.constr()
CertificateBody: str = pydantic.constr(min=1, max=32768, pattern=r'-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?')
CertificateBodyBlob: bytes = pydantic.conbytes(min=1, max=32768)
CertificateChain: str = pydantic.constr(min=1, max=2097152, pattern=r'(-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}\u000D?\u000A)*-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?')
...
DomainNameString: str = pydantic.constr(min=1, max=253, pattern=r'^(\*\.)?(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$')
...
NextToken: str = pydantic.constr(min=1, max=10000, pattern=r'[\u0009\u000A\u000D\u0020-\u00FF]*')
NullableBoolean: bool = pydantic.conbool()
PassphraseBlob: bytes = pydantic.conbytes(min=4, max=128)
PcaArn: str = pydantic.constr(min=20, max=2048, pattern=r'arn:[\w+=/,.@-]+:acm-pca:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*')
PositiveInteger: int = pydantic.conint(min=1)
PrivateKey: str = pydantic.constr(min=1, max=524288, pattern=r'-{5}BEGIN PRIVATE KEY-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END PRIVATE KEY-{5}(\u000D?\u000A)?')
...
class CertificateDetail(_ACMBase):
    ...
    subject_alternative_names: DomainList = pydantic.Field(None, alias="SubjectAlternativeNames")
    domain_validation_options: DomainValidationList = pydantic.Field(None, alias="DomainValidationOptions")
    ...
    extended_key_usages: ExtendedKeyUsageList = pydantic.Field(None, alias="ExtendedKeyUsages")
    certificate_authority_arn: Arn = pydantic.Field(None, alias="CertificateAuthorityArn")
    renewal_eligibility: RenewalEligibility = pydantic.Field(None, alias="RenewalEligibility")
    options: 'CertificateOptions' = pydantic.Field(None, alias="Options")

class CertificateOptions(_ACMBase):
    certificate_transparency_logging_preference: CertificateTransparencyLoggingPreference = pydantic.Field(None, alias="CertificateTransparencyLoggingPreference")

class CertificateSummary(_ACMBase):
    certificate_arn: Arn = pydantic.Field(None, alias="CertificateArn")
    domain_name: DomainNameString = pydantic.Field(None, alias="DomainName")
    subject_alternative_name_summaries: DomainList = pydantic.Field(None, alias="SubjectAlternativeNameSummaries")
    has_additional_subject_alternative_names: NullableBoolean = pydantic.Field(None, alias="HasAdditionalSubjectAlternativeNames")
    status: CertificateStatus = pydantic.Field(None, alias="Status")
    type: CertificateType = pydantic.Field(None, alias="Type")
    key_algorithm: KeyAlgorithm = pydantic.Field(None, alias="KeyAlgorithm")
    key_usages: KeyUsageNames = pydantic.Field(None, alias="KeyUsages")
    extended_key_usages: ExtendedKeyUsageNames = pydantic.Field(None, alias="ExtendedKeyUsages")
...
class DomainValidation(_ACMBase):
    domain_name: DomainNameString = pydantic.Field(None, alias="DomainName")
    validation_emails: ValidationEmailList = pydantic.Field(None, alias="ValidationEmails")
...
class Filters(_ACMBase):
    extended_key_usage: ExtendedKeyUsageFilterList = pydantic.Field(None, alias="extendedKeyUsage")
...
class GetAccountConfigurationResponse(_ACMBase):
    expiry_events: 'ExpiryEventsConfiguration' = pydantic.Field(None, alias="ExpiryEvents")
...
class ListCertificatesRequest(_ACMBase):
    certificate_statuses: CertificateStatuses = pydantic.Field(None, alias="CertificateStatuses")
...
class ListCertificatesResponse(_ACMBase):
    next_token: NextToken = pydantic.Field(None, alias="NextToken")
    certificate_summary_list: CertificateSummaryList = pydantic.Field(None, alias="CertificateSummaryList")
...
class RenewalSummary(_ACMBase):
    ...
    domain_validation_options: DomainValidationList = pydantic.Field(None, alias="DomainValidationOptions")
    renewal_status_reason: FailureReason = pydantic.Field(None, alias="RenewalStatusReason")
...
class RequestCertificateRequest(_ACMBase):
    ...
    subject_alternative_names: DomainList = pydantic.Field(None, alias="SubjectAlternativeNames")
    idempotency_token: IdempotencyToken = pydantic.Field(None, alias="IdempotencyToken")
    domain_validation_options: DomainValidationOptionList = pydantic.Field(None, alias="DomainValidationOptions")
    options: 'CertificateOptions' = pydantic.Field(None, alias="Options")
    certificate_authority_arn: PcaArn = pydantic.Field(None, alias="CertificateAuthorityArn")
    tags: TagList = pydantic.Field(None, alias="Tags")
    key_algorithm: KeyAlgorithm = pydantic.Field(None, alias="KeyAlgorithm")

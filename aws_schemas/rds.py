...
DBInstanceAutomatedBackupsReplicationList = typing.List[
...
MinimumEngineVersionPerAllowedValueList = typing.List[
...
class AddSourceIdentifierToSubscriptionResult(_RDSBase):
    event_subscription: "EventSubscription" = pydantic.Field(
...
class ApplyPendingMaintenanceActionResult(_RDSBase):
    resource_pending_maintenance_actions: "ResourcePendingMaintenanceActions" = (
        pydantic.Field(None, alias="ResourcePendingMaintenanceActions")
    )
...
class BacktrackDBClusterMessage(_RDSBase):
    ...
    use_earliest_time_on_point_in_time_unavailable: BooleanOptional = pydantic.Field(
        None, alias="UseEarliestTimeOnPointInTimeUnavailable"
    )


class BlueGreenDeployment(_RDSBase):
    blue_green_deployment_identifier: BlueGreenDeploymentIdentifier = pydantic.Field(
        None, alias="BlueGreenDeploymentIdentifier"
    )
    blue_green_deployment_name: BlueGreenDeploymentName = pydantic.Field(
    ...
    switchover_details: SwitchoverDetailList = pydantic.Field(
        None, alias="SwitchoverDetails"
    )
    ...
    status_details: BlueGreenDeploymentStatusDetails = pydantic.Field(
        None, alias="StatusDetails"
    )
...
class Certificate(_RDSBase):
    ...
    customer_override_valid_till: "TStamp" = pydantic.Field(
        None, alias="CustomerOverrideValidTill"
    )
...
class CharacterSet(_RDSBase):
    ...
    character_set_description: String = pydantic.Field(
        None, alias="CharacterSetDescription"
    )
...
class ClusterPendingModifiedValues(_RDSBase):
    pending_cloudwatch_logs_exports: "PendingCloudwatchLogsExports" = pydantic.Field(
        None, alias="PendingCloudwatchLogsExports"
    )
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    master_user_password: String = pydantic.Field(None, alias="MasterUserPassword")
    iam_database_authentication_enabled: BooleanOptional = pydantic.Field(
        None, alias="IAMDatabaseAuthenticationEnabled"
    )
    engine_version: String = pydantic.Field(None, alias="EngineVersion")
    backup_retention_period: IntegerOptional = pydantic.Field(
        None, alias="BackupRetentionPeriod"
    )
...
class ConnectionPoolConfiguration(_RDSBase):
    max_connections_percent: IntegerOptional = pydantic.Field(
        None, alias="MaxConnectionsPercent"
    )
    max_idle_connections_percent: IntegerOptional = pydantic.Field(
        None, alias="MaxIdleConnectionsPercent"
    )
    connection_borrow_timeout: IntegerOptional = pydantic.Field(
        None, alias="ConnectionBorrowTimeout"
    )
    session_pinning_filters: StringList = pydantic.Field(
        None, alias="SessionPinningFilters"
    )
    init_query: String = pydantic.Field(None, alias="InitQuery")


class ConnectionPoolConfigurationInfo(_RDSBase):
    max_connections_percent: Integer = pydantic.Field(
        None, alias="MaxConnectionsPercent"
    )
    max_idle_connections_percent: Integer = pydantic.Field(
        None, alias="MaxIdleConnectionsPercent"
    )
    connection_borrow_timeout: Integer = pydantic.Field(
        None, alias="ConnectionBorrowTimeout"
    )
    session_pinning_filters: StringList = pydantic.Field(
        None, alias="SessionPinningFilters"
...
class CopyDBClusterParameterGroupMessage(_RDSBase):
    source_db_cluster_parameter_group_identifier: String = pydantic.Field(
        None, alias="SourceDBClusterParameterGroupIdentifier"
    )
    target_db_cluster_parameter_group_identifier: String = pydantic.Field(
        None, alias="TargetDBClusterParameterGroupIdentifier"
    )
    target_db_cluster_parameter_group_description: String = pydantic.Field(
        None, alias="TargetDBClusterParameterGroupDescription"
    )
    tags: TagList = pydantic.Field(None, alias="Tags")


class CopyDBClusterParameterGroupResult(_RDSBase):
    db_cluster_parameter_group: "DBClusterParameterGroup" = pydantic.Field(
        None, alias="DBClusterParameterGroup"
    )


class CopyDBClusterSnapshotMessage(_RDSBase):
    source_db_cluster_snapshot_identifier: String = pydantic.Field(
        None, alias="SourceDBClusterSnapshotIdentifier"
    )
    target_db_cluster_snapshot_identifier: String = pydantic.Field(
        None, alias="TargetDBClusterSnapshotIdentifier"
    )
...
class CopyDBClusterSnapshotResult(_RDSBase):
    db_cluster_snapshot: "DBClusterSnapshot" = pydantic.Field(
        None, alias="DBClusterSnapshot"
    )


class CopyDBParameterGroupMessage(_RDSBase):
    source_db_parameter_group_identifier: String = pydantic.Field(
        None, alias="SourceDBParameterGroupIdentifier"
    )
    target_db_parameter_group_identifier: String = pydantic.Field(
        None, alias="TargetDBParameterGroupIdentifier"
    )
    target_db_parameter_group_description: String = pydantic.Field(
        None, alias="TargetDBParameterGroupDescription"
    )
    tags: TagList = pydantic.Field(None, alias="Tags")


class CopyDBParameterGroupResult(_RDSBase):
    db_parameter_group: "DBParameterGroup" = pydantic.Field(
        None, alias="DBParameterGroup"
    )


class CopyDBSnapshotMessage(_RDSBase):
    source_db_snapshot_identifier: String = pydantic.Field(
        None, alias="SourceDBSnapshotIdentifier"
    )
    target_db_snapshot_identifier: String = pydantic.Field(
        None, alias="TargetDBSnapshotIdentifier"
    )
    kms_key_id: String = pydantic.Field(None, alias="KmsKeyId")
    tags: TagList = pydantic.Field(None, alias="Tags")
    copy_tags: BooleanOptional = pydantic.Field(None, alias="CopyTags")
    ...
    target_custom_availability_zone: String = pydantic.Field(
...
class CopyOptionGroupMessage(_RDSBase):
    source_option_group_identifier: String = pydantic.Field(
        None, alias="SourceOptionGroupIdentifier"
    )
    target_option_group_identifier: String = pydantic.Field(
        None, alias="TargetOptionGroupIdentifier"
    )
    target_option_group_description: String = pydantic.Field(
        None, alias="TargetOptionGroupDescription"
    )
    tags: TagList = pydantic.Field(None, alias="Tags")
...
class CreateBlueGreenDeploymentRequest(_RDSBase):
    ...
    source: DatabaseArn = pydantic.Field(None, alias="Source")
    target_engine_version: TargetEngineVersion = pydantic.Field(
        None, alias="TargetEngineVersion"
    )
    target_db_parameter_group_name: TargetDBParameterGroupName = pydantic.Field(
        None, alias="TargetDBParameterGroupName"
    )
    target_db_cluster_parameter_group_name: TargetDBClusterParameterGroupName = (
        pydantic.Field(None, alias="TargetDBClusterParameterGroupName")
    )
    tags: TagList = pydantic.Field(None, alias="Tags")


class CreateBlueGreenDeploymentResponse(_RDSBase):
    blue_green_deployment: "BlueGreenDeployment" = pydantic.Field(
...
class CreateCustomDBEngineVersionMessage(_RDSBase):
    ...
    database_installation_files_s_3_bucket_name: BucketName = pydantic.Field(
        None, alias="DatabaseInstallationFilesS3BucketName"
    )
    database_installation_files_s_3_prefix: String255 = pydantic.Field(
        None, alias="DatabaseInstallationFilesS3Prefix"
    )
...
class CreateDBClusterEndpointMessage(_RDSBase):
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    db_cluster_endpoint_identifier: String = pydantic.Field(
...
class CreateDBClusterMessage(_RDSBase):
    availability_zones: AvailabilityZones = pydantic.Field(
    ...
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    db_cluster_parameter_group_name: String = pydantic.Field(
        None, alias="DBClusterParameterGroupName"
    )
    vpc_security_group_ids: VpcSecurityGroupIdList = pydantic.Field(
    ...
    master_user_password: String = pydantic.Field(None, alias="MasterUserPassword")
    option_group_name: String = pydantic.Field(None, alias="OptionGroupName")
    preferred_backup_window: String = pydantic.Field(
        None, alias="PreferredBackupWindow"
    )
    preferred_maintenance_window: String = pydantic.Field(
        None, alias="PreferredMaintenanceWindow"
    )
    replication_source_identifier: String = pydantic.Field(
    ...
    kms_key_id: String = pydantic.Field(None, alias="KmsKeyId")
    pre_signed_url: String = pydantic.Field(None, alias="PreSignedUrl")
    enable_iam_database_authentication: BooleanOptional = pydantic.Field(
        None, alias="EnableIAMDatabaseAuthentication"
    )
    backtrack_window: LongOptional = pydantic.Field(None, alias="BacktrackWindow")
    enable_cloudwatch_logs_exports: LogTypeList = pydantic.Field(
        None, alias="EnableCloudwatchLogsExports"
    )
    engine_mode: String = pydantic.Field(None, alias="EngineMode")
    scaling_configuration: "ScalingConfiguration" = pydantic.Field(
        None, alias="ScalingConfiguration"
    )
    deletion_protection: BooleanOptional = pydantic.Field(
        None, alias="DeletionProtection"
    )
    global_cluster_identifier: String = pydantic.Field(
        None, alias="GlobalClusterIdentifier"
    )
    enable_http_endpoint: BooleanOptional = pydantic.Field(
        None, alias="EnableHttpEndpoint"
    )
    copy_tags_to_snapshot: BooleanOptional = pydantic.Field(
        None, alias="CopyTagsToSnapshot"
    )
    domain: String = pydantic.Field(None, alias="Domain")
    domain_iam_role_name: String = pydantic.Field(None, alias="DomainIAMRoleName")
    enable_global_write_forwarding: BooleanOptional = pydantic.Field(
        None, alias="EnableGlobalWriteForwarding"
    )
    db_cluster_instance_class: String = pydantic.Field(
    ...
    auto_minor_version_upgrade: BooleanOptional = pydantic.Field(
        None, alias="AutoMinorVersionUpgrade"
    )
    monitoring_interval: IntegerOptional = pydantic.Field(
        None, alias="MonitoringInterval"
    )
    monitoring_role_arn: String = pydantic.Field(None, alias="MonitoringRoleArn")
    enable_performance_insights: BooleanOptional = pydantic.Field(
        None, alias="EnablePerformanceInsights"
    )
    performance_insights_kms_key_id: String = pydantic.Field(
    ...
    manage_master_user_password: BooleanOptional = pydantic.Field(
        None, alias="ManageMasterUserPassword"
    )
    master_user_secret_kms_key_id: String = pydantic.Field(
...
class CreateDBClusterParameterGroupMessage(_RDSBase):
    ...
    db_parameter_group_family: String = pydantic.Field(
...
class CreateDBClusterSnapshotMessage(_RDSBase):
    db_cluster_snapshot_identifier: String = pydantic.Field(
...
class CreateDBInstanceMessage(_RDSBase):
    ...
    master_username: String = pydantic.Field(None, alias="MasterUsername")
    master_user_password: String = pydantic.Field(None, alias="MasterUserPassword")
    db_security_groups: DBSecurityGroupNameList = pydantic.Field(
    ...
    option_group_name: String = pydantic.Field(None, alias="OptionGroupName")
    character_set_name: String = pydantic.Field(None, alias="CharacterSetName")
    nchar_character_set_name: String = pydantic.Field(
    ...
    tde_credential_password: String = pydantic.Field(
        None, alias="TdeCredentialPassword"
    )
    storage_encrypted: BooleanOptional = pydantic.Field(None, alias="StorageEncrypted")
    kms_key_id: String = pydantic.Field(None, alias="KmsKeyId")
    domain: String = pydantic.Field(None, alias="Domain")
    ...
    processor_features: ProcessorFeatureList = pydantic.Field(
        None, alias="ProcessorFeatures"
    )
    deletion_protection: BooleanOptional = pydantic.Field(
        None, alias="DeletionProtection"
    )
    max_allocated_storage: IntegerOptional = pydantic.Field(
        None, alias="MaxAllocatedStorage"
    )
    enable_customer_owned_ip: BooleanOptional = pydantic.Field(
        None, alias="EnableCustomerOwnedIp"
    )
    custom_iam_instance_profile: String = pydantic.Field(
        None, alias="CustomIamInstanceProfile"
    )
    backup_target: String = pydantic.Field(None, alias="BackupTarget")
    network_type: String = pydantic.Field(None, alias="NetworkType")
    storage_throughput: IntegerOptional = pydantic.Field(
        None, alias="StorageThroughput"
    )
    manage_master_user_password: BooleanOptional = pydantic.Field(
        None, alias="ManageMasterUserPassword"
    )
    ...
    ca_certificate_identifier: String = pydantic.Field(
...
class CreateDBInstanceReadReplicaMessage(_RDSBase):
    db_instance_identifier: String = pydantic.Field(None, alias="DBInstanceIdentifier")
    source_db_instance_identifier: String = pydantic.Field(
    ...
    use_default_processor_features: BooleanOptional = pydantic.Field(
    ...
    allocated_storage: IntegerOptional = pydantic.Field(None, alias="AllocatedStorage")
    source_db_cluster_identifier: String = pydantic.Field(
...
class CreateDBProxyEndpointRequest(_RDSBase):
    ...
    db_proxy_endpoint_name: DBProxyEndpointName = pydantic.Field(
        None, alias="DBProxyEndpointName"
    )
    vpc_subnet_ids: StringList = pydantic.Field(None, alias="VpcSubnetIds")
    vpc_security_group_ids: StringList = pydantic.Field(
        None, alias="VpcSecurityGroupIds"
    )
...
class CreateDBProxyRequest(_RDSBase):
    ...
    idle_client_timeout: IntegerOptional = pydantic.Field(
        None, alias="IdleClientTimeout"
    )
...
class CreateDBSecurityGroupMessage(_RDSBase):
    db_security_group_name: String = pydantic.Field(None, alias="DBSecurityGroupName")
    db_security_group_description: String = pydantic.Field(
...
class CreateDBSubnetGroupMessage(_RDSBase):
    db_subnet_group_name: String = pydantic.Field(None, alias="DBSubnetGroupName")
    db_subnet_group_description: String = pydantic.Field(
...
class CreateEventSubscriptionMessage(_RDSBase):
    ...
    event_categories: EventCategoriesList = pydantic.Field(
        None, alias="EventCategories"
    )
...
class CreateOptionGroupMessage(_RDSBase):
    ...
    option_group_description: String = pydantic.Field(
        None, alias="OptionGroupDescription"
    )
    tags: TagList = pydantic.Field(None, alias="Tags")
...
class DBCluster(_RDSBase):
    ...
    database_name: String = pydantic.Field(None, alias="DatabaseName")
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    db_cluster_parameter_group: String = pydantic.Field(
        None, alias="DBClusterParameterGroup"
    )
    db_subnet_group: String = pydantic.Field(None, alias="DBSubnetGroup")
    status: String = pydantic.Field(None, alias="Status")
    automatic_restart_time: "TStamp" = pydantic.Field(
        None, alias="AutomaticRestartTime"
    )
    percent_progress: String = pydantic.Field(None, alias="PercentProgress")
    earliest_restorable_time: "TStamp" = pydantic.Field(
        None, alias="EarliestRestorableTime"
    )
    ...
    engine: String = pydantic.Field(None, alias="Engine")
    engine_version: String = pydantic.Field(None, alias="EngineVersion")
    latest_restorable_time: "TStamp" = pydantic.Field(
        None, alias="LatestRestorableTime"
    )
    port: IntegerOptional = pydantic.Field(None, alias="Port")
    master_username: String = pydantic.Field(None, alias="MasterUsername")
    db_cluster_option_group_memberships: DBClusterOptionGroupMemberships = (
        pydantic.Field(None, alias="DBClusterOptionGroupMemberships")
    )
    preferred_backup_window: String = pydantic.Field(
        None, alias="PreferredBackupWindow"
    )
    ...
    read_replica_identifiers: ReadReplicaIdentifierList = pydantic.Field(
        None, alias="ReadReplicaIdentifiers"
    )
    db_cluster_members: DBClusterMemberList = pydantic.Field(
        None, alias="DBClusterMembers"
    )
    vpc_security_groups: VpcSecurityGroupMembershipList = pydantic.Field(
        None, alias="VpcSecurityGroups"
    )
    ...
    earliest_backtrack_time: "TStamp" = pydantic.Field(
        None, alias="EarliestBacktrackTime"
    )
    backtrack_window: LongOptional = pydantic.Field(None, alias="BacktrackWindow")
    backtrack_consumed_change_records: LongOptional = pydantic.Field(
        None, alias="BacktrackConsumedChangeRecords"
    )
    enabled_cloudwatch_logs_exports: LogTypeList = pydantic.Field(
        None, alias="EnabledCloudwatchLogsExports"
    )
    capacity: IntegerOptional = pydantic.Field(None, alias="Capacity")
    engine_mode: String = pydantic.Field(None, alias="EngineMode")
    scaling_configuration_info: "ScalingConfigurationInfo" = pydantic.Field(
        None, alias="ScalingConfigurationInfo"
    )
    deletion_protection: BooleanOptional = pydantic.Field(
        None, alias="DeletionProtection"
    )
    http_endpoint_enabled: BooleanOptional = pydantic.Field(
        None, alias="HttpEndpointEnabled"
    )
    activity_stream_mode: ActivityStreamMode = pydantic.Field(
        None, alias="ActivityStreamMode"
    )
    activity_stream_status: ActivityStreamStatus = pydantic.Field(
        None, alias="ActivityStreamStatus"
    )
    activity_stream_kms_key_id: String = pydantic.Field(
        None, alias="ActivityStreamKmsKeyId"
    )
    activity_stream_kinesis_stream_name: String = pydantic.Field(
        None, alias="ActivityStreamKinesisStreamName"
    )
    copy_tags_to_snapshot: BooleanOptional = pydantic.Field(
        None, alias="CopyTagsToSnapshot"
    )
    cross_account_clone: BooleanOptional = pydantic.Field(
        None, alias="CrossAccountClone"
    )
    domain_memberships: DomainMembershipList = pydantic.Field(
        None, alias="DomainMemberships"
    )
    tag_list: TagList = pydantic.Field(None, alias="TagList")
    global_write_forwarding_status: WriteForwardingStatus = pydantic.Field(
        None, alias="GlobalWriteForwardingStatus"
    )
    global_write_forwarding_requested: BooleanOptional = pydantic.Field(
        None, alias="GlobalWriteForwardingRequested"
    )
    pending_modified_values: "ClusterPendingModifiedValues" = pydantic.Field(
    ...
    auto_minor_version_upgrade: Boolean = pydantic.Field(
        None, alias="AutoMinorVersionUpgrade"
    )
    monitoring_interval: IntegerOptional = pydantic.Field(
        None, alias="MonitoringInterval"
    ...
    monitoring_role_arn: String = pydantic.Field(None, alias="MonitoringRoleArn")
    performance_insights_enabled: BooleanOptional = pydantic.Field(
        None, alias="PerformanceInsightsEnabled"
    )
    performance_insights_kms_key_id: String = pydantic.Field(
        None, alias="PerformanceInsightsKMSKeyId"
    )
    ...
    network_type: String = pydantic.Field(None, alias="NetworkType")
    db_system_id: String = pydantic.Field(None, alias="DBSystemId")
    master_user_secret: "MasterUserSecret" = pydantic.Field(
        None, alias="MasterUserSecret"
    )
    io_optimized_next_allowed_modification_time: "TStamp" = pydantic.Field(
        None, alias="IOOptimizedNextAllowedModificationTime"
    )
...
class DBClusterBacktrack(_RDSBase):
    ...
    backtrack_request_creation_time: "TStamp" = pydantic.Field(
        None, alias="BacktrackRequestCreationTime"
    )
    status: String = pydantic.Field(None, alias="Status")
...
class DBClusterBacktrackMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_cluster_backtracks: DBClusterBacktrackList = pydantic.Field(
        None, alias="DBClusterBacktracks"
    )
...
class DBClusterCapacityInfo(_RDSBase):
    ...
    seconds_before_timeout: IntegerOptional = pydantic.Field(
        None, alias="SecondsBeforeTimeout"
    )
...
class DBClusterEndpoint(_RDSBase):
    ...
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    db_cluster_endpoint_resource_identifier: String = pydantic.Field(
        None, alias="DBClusterEndpointResourceIdentifier"
    )
    endpoint: String = pydantic.Field(None, alias="Endpoint")
    status: String = pydantic.Field(None, alias="Status")
    endpoint_type: String = pydantic.Field(None, alias="EndpointType")
...
class DBClusterEndpointMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_cluster_endpoints: DBClusterEndpointList = pydantic.Field(
        None, alias="DBClusterEndpoints"
    )
...
class DBClusterMember(_RDSBase):
    ...
    db_cluster_parameter_group_status: String = pydantic.Field(
        None, alias="DBClusterParameterGroupStatus"
    )
    promotion_tier: IntegerOptional = pydantic.Field(None, alias="PromotionTier")
...
class DBClusterOptionGroupStatus(_RDSBase):
    db_cluster_option_group_name: String = pydantic.Field(
        None, alias="DBClusterOptionGroupName"
    )
    status: String = pydantic.Field(None, alias="Status")
...
class DBClusterParameterGroup(_RDSBase):
    ...
    description: String = pydantic.Field(None, alias="Description")
    db_cluster_parameter_group_arn: String = pydantic.Field(
        None, alias="DBClusterParameterGroupArn"
    )
...
class DBClusterParameterGroupsMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_cluster_parameter_groups: DBClusterParameterGroupList = pydantic.Field(
        None, alias="DBClusterParameterGroups"
    )
...
class DBClusterSnapshot(_RDSBase):
    ...
    source_db_cluster_snapshot_arn: String = pydantic.Field(
        None, alias="SourceDBClusterSnapshotArn"
    )
    iam_database_authentication_enabled: Boolean = pydantic.Field(
        None, alias="IAMDatabaseAuthenticationEnabled"
    )
    tag_list: TagList = pydantic.Field(None, alias="TagList")
    db_system_id: String = pydantic.Field(None, alias="DBSystemId")
...
class DBClusterSnapshotAttributesResult(_RDSBase):
    ...
    db_cluster_snapshot_attributes: DBClusterSnapshotAttributeList = pydantic.Field(
        None, alias="DBClusterSnapshotAttributes"
    )


class DBClusterSnapshotMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_cluster_snapshots: DBClusterSnapshotList = pydantic.Field(
        None, alias="DBClusterSnapshots"
    )
...
class DBEngineVersion(_RDSBase):
    ...
    db_engine_version_description: String = pydantic.Field(
        None, alias="DBEngineVersionDescription"
    )
    default_character_set: "CharacterSet" = pydantic.Field(
        None, alias="DefaultCharacterSet"
    )
    ...
    supported_character_sets: SupportedCharacterSetsList = pydantic.Field(
        None, alias="SupportedCharacterSets"
    )
    supported_nchar_character_sets: SupportedCharacterSetsList = pydantic.Field(
        None, alias="SupportedNcharCharacterSets"
    )
    valid_upgrade_target: ValidUpgradeTargetList = pydantic.Field(
        None, alias="ValidUpgradeTarget"
    )
    supported_timezones: SupportedTimezonesList = pydantic.Field(
        None, alias="SupportedTimezones"
    )
    exportable_log_types: LogTypeList = pydantic.Field(None, alias="ExportableLogTypes")
    supports_log_exports_to_cloudwatch_logs: Boolean = pydantic.Field(
        None, alias="SupportsLogExportsToCloudwatchLogs"
    )
    supports_read_replica: Boolean = pydantic.Field(None, alias="SupportsReadReplica")
    supported_engine_modes: EngineModeList = pydantic.Field(
        None, alias="SupportedEngineModes"
    )
    supported_feature_names: FeatureNameList = pydantic.Field(
        None, alias="SupportedFeatureNames"
    )
    status: String = pydantic.Field(None, alias="Status")
    supports_parallel_query: Boolean = pydantic.Field(
        None, alias="SupportsParallelQuery"
    )
    supports_global_databases: Boolean = pydantic.Field(
        None, alias="SupportsGlobalDatabases"
    )
    major_engine_version: String = pydantic.Field(None, alias="MajorEngineVersion")
    database_installation_files_s_3_bucket_name: String = pydantic.Field(
        None, alias="DatabaseInstallationFilesS3BucketName"
    )
    database_installation_files_s_3_prefix: String = pydantic.Field(
        None, alias="DatabaseInstallationFilesS3Prefix"
    )
    ...
    custom_db_engine_version_manifest: CustomDBEngineVersionManifest = pydantic.Field(
        None, alias="CustomDBEngineVersionManifest"
    )
    supports_certificate_rotation_without_restart: BooleanOptional = pydantic.Field(
        None, alias="SupportsCertificateRotationWithoutRestart"
    )
    supported_ca_certificate_identifiers: CACertificateIdentifiersList = pydantic.Field(
        None, alias="SupportedCACertificateIdentifiers"
    )


class DBEngineVersionMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_engine_versions: DBEngineVersionList = pydantic.Field(
        None, alias="DBEngineVersions"
    )
...
class DBInstance(_RDSBase):
    ...
    backup_retention_period: Integer = pydantic.Field(
        None, alias="BackupRetentionPeriod"
    )
    db_security_groups: DBSecurityGroupMembershipList = pydantic.Field(
        None, alias="DBSecurityGroups"
    )
    vpc_security_groups: VpcSecurityGroupMembershipList = pydantic.Field(
        None, alias="VpcSecurityGroups"
    )
    db_parameter_groups: DBParameterGroupStatusList = pydantic.Field(
        None, alias="DBParameterGroups"
    )
    availability_zone: String = pydantic.Field(None, alias="AvailabilityZone")
    db_subnet_group: "DBSubnetGroup" = pydantic.Field(None, alias="DBSubnetGroup")
    preferred_maintenance_window: String = pydantic.Field(
    ...
    pending_modified_values: "PendingModifiedValues" = pydantic.Field(
        None, alias="PendingModifiedValues"
    )
    latest_restorable_time: "TStamp" = pydantic.Field(
        None, alias="LatestRestorableTime"
    ...
    read_replica_source_db_instance_identifier: String = pydantic.Field(
        None, alias="ReadReplicaSourceDBInstanceIdentifier"
    )
    read_replica_db_instance_identifiers: ReadReplicaDBInstanceIdentifierList = (
        pydantic.Field(None, alias="ReadReplicaDBInstanceIdentifiers")
    )
    read_replica_db_cluster_identifiers: ReadReplicaDBClusterIdentifierList = (
        pydantic.Field(None, alias="ReadReplicaDBClusterIdentifiers")
    )
    replica_mode: ReplicaMode = pydantic.Field(None, alias="ReplicaMode")
    license_model: String = pydantic.Field(None, alias="LicenseModel")
    iops: IntegerOptional = pydantic.Field(None, alias="Iops")
    option_group_memberships: OptionGroupMembershipList = pydantic.Field(
        None, alias="OptionGroupMemberships"
    )
    character_set_name: String = pydantic.Field(None, alias="CharacterSetName")
    nchar_character_set_name: String = pydantic.Field(
        None, alias="NcharCharacterSetName"
    )
    secondary_availability_zone: String = pydantic.Field(
        None, alias="SecondaryAvailabilityZone"
    )
    ...
    enhanced_monitoring_resource_arn: String = pydantic.Field(
        None, alias="EnhancedMonitoringResourceArn"
    )
    monitoring_role_arn: String = pydantic.Field(None, alias="MonitoringRoleArn")
    promotion_tier: IntegerOptional = pydantic.Field(None, alias="PromotionTier")
    ...
    tag_list: TagList = pydantic.Field(None, alias="TagList")
    db_instance_automated_backups_replications: DBInstanceAutomatedBackupsReplicationList = pydantic.Field(
        None, alias="DBInstanceAutomatedBackupsReplications"
    )
    customer_owned_ip_enabled: BooleanOptional = pydantic.Field(
        None, alias="CustomerOwnedIpEnabled"
    )
    aws_backup_recovery_point_arn: String = pydantic.Field(
    ...
    activity_stream_engine_native_audit_fields_included: BooleanOptional = (
        pydantic.Field(None, alias="ActivityStreamEngineNativeAuditFieldsIncluded")
    )
    automation_mode: AutomationMode = pydantic.Field(None, alias="AutomationMode")
    resume_full_automation_mode_time: "TStamp" = pydantic.Field(
        None, alias="ResumeFullAutomationModeTime"
    )
    custom_iam_instance_profile: String = pydantic.Field(
        None, alias="CustomIamInstanceProfile"
    )
    backup_target: String = pydantic.Field(None, alias="BackupTarget")
    network_type: String = pydantic.Field(None, alias="NetworkType")
    activity_stream_policy_status: ActivityStreamPolicyStatus = pydantic.Field(
    ...
    certificate_details: "CertificateDetails" = pydantic.Field(
        None, alias="CertificateDetails"
    )
    read_replica_source_db_cluster_identifier: String = pydantic.Field(
        None, alias="ReadReplicaSourceDBClusterIdentifier"
    )
...
class DBInstanceAutomatedBackup(_RDSBase):
    ...
    db_instance_automated_backups_arn: String = pydantic.Field(
...
class DBInstanceAutomatedBackupMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_instance_automated_backups: DBInstanceAutomatedBackupList = pydantic.Field(
        None, alias="DBInstanceAutomatedBackups"
    )
...
class DBParameterGroupsMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_parameter_groups: DBParameterGroupList = pydantic.Field(
        None, alias="DBParameterGroups"
    )
...
class DBProxyTargetGroup(_RDSBase):
    ...
    is_default: Boolean = pydantic.Field(None, alias="IsDefault")
    status: String = pydantic.Field(None, alias="Status")
    connection_pool_config: "ConnectionPoolConfigurationInfo" = pydantic.Field(
...
class DBSecurityGroupMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    db_security_groups: DBSecurityGroups = pydantic.Field(
        None, alias="DBSecurityGroups"
    )
...
class DBSnapshot(_RDSBase):
    ...
    dbi_resource_id: String = pydantic.Field(None, alias="DbiResourceId")
    tag_list: TagList = pydantic.Field(None, alias="TagList")
    original_snapshot_create_time: "TStamp" = pydantic.Field(
        None, alias="OriginalSnapshotCreateTime"
    )
    snapshot_database_time: "TStamp" = pydantic.Field(
        None, alias="SnapshotDatabaseTime"
    )
...
class DBSnapshotAttributesResult(_RDSBase):
    db_snapshot_identifier: String = pydantic.Field(None, alias="DBSnapshotIdentifier")
    db_snapshot_attributes: DBSnapshotAttributeList = pydantic.Field(
        None, alias="DBSnapshotAttributes"
    )
...
class DBSubnetGroup(_RDSBase):
    ...
    supported_network_types: StringList = pydantic.Field(
        None, alias="SupportedNetworkTypes"
    )
...
class DeleteDBClusterMessage(_RDSBase):
    ...
    final_db_snapshot_identifier: String = pydantic.Field(
...
class DeleteDBInstanceAutomatedBackupResult(_RDSBase):
    db_instance_automated_backup: "DBInstanceAutomatedBackup" = pydantic.Field(
...
class DeleteDBInstanceMessage(_RDSBase):
    ...
    delete_automated_backups: BooleanOptional = pydantic.Field(
...
class DeregisterDBProxyTargetsRequest(_RDSBase):
    db_proxy_name: String = pydantic.Field(None, alias="DBProxyName")
    target_group_name: String = pydantic.Field(None, alias="TargetGroupName")
    db_instance_identifiers: StringList = pydantic.Field(
        None, alias="DBInstanceIdentifiers"
    )
    db_cluster_identifiers: StringList = pydantic.Field(
...
class DescribeBlueGreenDeploymentsResponse(_RDSBase):
    blue_green_deployments: BlueGreenDeploymentList = pydantic.Field(
        None, alias="BlueGreenDeployments"
    )
    marker: String = pydantic.Field(None, alias="Marker")
...
class DescribeDBClusterSnapshotAttributesResult(_RDSBase):
    db_cluster_snapshot_attributes_result: "DBClusterSnapshotAttributesResult" = (
        pydantic.Field(None, alias="DBClusterSnapshotAttributesResult")
    )
...
class DescribeDBEngineVersionsMessage(_RDSBase):
    ...
    list_supported_character_sets: BooleanOptional = pydantic.Field(
        None, alias="ListSupportedCharacterSets"
    )
    list_supported_timezones: BooleanOptional = pydantic.Field(
...
class DescribeDBLogFilesResponse(_RDSBase):
    describe_db_log_files: DescribeDBLogFilesList = pydantic.Field(
        None, alias="DescribeDBLogFiles"
    )
    marker: String = pydantic.Field(None, alias="Marker")
...
class DescribeDBProxyEndpointsResponse(_RDSBase):
    db_proxy_endpoints: DBProxyEndpointList = pydantic.Field(
        None, alias="DBProxyEndpoints"
    )
    marker: String = pydantic.Field(None, alias="Marker")
...
class DescribeDBSnapshotAttributesResult(_RDSBase):
    db_snapshot_attributes_result: "DBSnapshotAttributesResult" = pydantic.Field(
...
class DescribeReservedDBInstancesMessage(_RDSBase):
    ...
    reserved_db_instances_offering_id: String = pydantic.Field(
...
class DescribeValidDBInstanceModificationsResult(_RDSBase):
    valid_db_instance_modifications_message: "ValidDBInstanceModificationsMessage" = (
        pydantic.Field(None, alias="ValidDBInstanceModificationsMessage")
    )
...
class DownloadDBLogFilePortionDetails(_RDSBase):
    ...
    marker: String = pydantic.Field(None, alias="Marker")
    additional_data_pending: Boolean = pydantic.Field(
        None, alias="AdditionalDataPending"
    )
...
class EventCategoriesMessage(_RDSBase):
    event_categories_map_list: EventCategoriesMapList = pydantic.Field(
...
class EventSubscription(_RDSBase):
    ...
    sns_topic_arn: String = pydantic.Field(None, alias="SnsTopicArn")
    status: String = pydantic.Field(None, alias="Status")
    subscription_creation_time: String = pydantic.Field(
        None, alias="SubscriptionCreationTime"
    )
    source_type: String = pydantic.Field(None, alias="SourceType")
    source_ids_list: SourceIdsList = pydantic.Field(None, alias="SourceIdsList")
    event_categories_list: EventCategoriesList = pydantic.Field(
...
class EventSubscriptionsMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    event_subscriptions_list: EventSubscriptionsList = pydantic.Field(
...
class ExportTask(_RDSBase):
    ...
    status: String = pydantic.Field(None, alias="Status")
    percent_progress: Integer = pydantic.Field(None, alias="PercentProgress")
    total_extracted_data_in_gb: Integer = pydantic.Field(
        None, alias="TotalExtractedDataInGB"
    )
...
class FailoverDBClusterMessage(_RDSBase):
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    target_db_instance_identifier: String = pydantic.Field(
...
class FailoverGlobalClusterMessage(_RDSBase):
    global_cluster_identifier: GlobalClusterIdentifier = pydantic.Field(
        None, alias="GlobalClusterIdentifier"
    )
    target_db_cluster_identifier: DBClusterIdentifier = pydantic.Field(
        None, alias="TargetDbClusterIdentifier"
    )
...
class GlobalCluster(_RDSBase):
    ...
    global_cluster_resource_id: String = pydantic.Field(
        None, alias="GlobalClusterResourceId"
    )
    ...
    global_cluster_members: GlobalClusterMemberList = pydantic.Field(
        None, alias="GlobalClusterMembers"
    )
...
class ModifyActivityStreamRequest(_RDSBase):
    ...
    audit_policy_state: AuditPolicyState = pydantic.Field(
...
class ModifyActivityStreamResponse(_RDSBase):
    ...
    engine_native_audit_fields_included: BooleanOptional = pydantic.Field(
        None, alias="EngineNativeAuditFieldsIncluded"
    )
    policy_status: ActivityStreamPolicyStatus = pydantic.Field(
        None, alias="PolicyStatus"
    )


class ModifyCertificatesMessage(_RDSBase):
    certificate_identifier: String = pydantic.Field(None, alias="CertificateIdentifier")
    remove_customer_override: BooleanOptional = pydantic.Field(
...
class ModifyDBClusterMessage(_RDSBase):
    db_cluster_identifier: String = pydantic.Field(None, alias="DBClusterIdentifier")
    new_db_cluster_identifier: String = pydantic.Field(
    ...
    cloudwatch_logs_export_configuration: "CloudwatchLogsExportConfiguration" = (
        pydantic.Field(None, alias="CloudwatchLogsExportConfiguration")
    )
    engine_version: String = pydantic.Field(None, alias="EngineVersion")
    allow_major_version_upgrade: Boolean = pydantic.Field(
        None, alias="AllowMajorVersionUpgrade"
    )
    db_instance_parameter_group_name: String = pydantic.Field(
    ...
    rotate_master_user_password: BooleanOptional = pydantic.Field(
    ...
    engine_mode: String = pydantic.Field(None, alias="EngineMode")
    allow_engine_mode_change: Boolean = pydantic.Field(
...
class ModifyDBInstanceMessage(_RDSBase):
    ...
    iops: IntegerOptional = pydantic.Field(None, alias="Iops")
    option_group_name: String = pydantic.Field(None, alias="OptionGroupName")
    new_db_instance_identifier: String = pydantic.Field(
    ...
    certificate_rotation_restart: BooleanOptional = pydantic.Field(
    ...
    aws_backup_recovery_point_arn: AwsBackupRecoveryPointArn = pydantic.Field(
        None, alias="AwsBackupRecoveryPointArn"
    )
    automation_mode: AutomationMode = pydantic.Field(None, alias="AutomationMode")
    resume_full_automation_mode_minutes: IntegerOptional = pydantic.Field(
...
class ModifyDBProxyEndpointRequest(_RDSBase):
    ...
    new_db_proxy_endpoint_name: DBProxyEndpointName = pydantic.Field(
        None, alias="NewDBProxyEndpointName"
    )
    vpc_security_group_ids: StringList = pydantic.Field(
        None, alias="VpcSecurityGroupIds"
    )
...
class ModifyDBProxyTargetGroupRequest(_RDSBase):
    target_group_name: String = pydantic.Field(None, alias="TargetGroupName")
    db_proxy_name: String = pydantic.Field(None, alias="DBProxyName")
    connection_pool_config: "ConnectionPoolConfiguration" = pydantic.Field(
        None, alias="ConnectionPoolConfig"
    )
...
class ModifyDBProxyTargetGroupResponse(_RDSBase):
    db_proxy_target_group: "DBProxyTargetGroup" = pydantic.Field(
...
class ModifyGlobalClusterMessage(_RDSBase):
    ...
    new_global_cluster_identifier: String = pydantic.Field(
    ...
    engine_version: String = pydantic.Field(None, alias="EngineVersion")
    allow_major_version_upgrade: BooleanOptional = pydantic.Field(
        None, alias="AllowMajorVersionUpgrade"
    )
...
class ModifyOptionGroupMessage(_RDSBase):
    option_group_name: String = pydantic.Field(None, alias="OptionGroupName")
    options_to_include: OptionConfigurationList = pydantic.Field(
...
class Option(_RDSBase):
    ...
    option_settings: OptionSettingConfigurationList = pydantic.Field(
        None, alias="OptionSettings"
    )
    db_security_group_memberships: DBSecurityGroupMembershipList = pydantic.Field(
        None, alias="DBSecurityGroupMemberships"
    )
    vpc_security_group_memberships: VpcSecurityGroupMembershipList = pydantic.Field(
        None, alias="VpcSecurityGroupMemberships"
    )
...
class OptionConfiguration(_RDSBase):
    ...
    port: IntegerOptional = pydantic.Field(None, alias="Port")
    option_version: String = pydantic.Field(None, alias="OptionVersion")
    db_security_group_memberships: DBSecurityGroupNameList = pydantic.Field(
        None, alias="DBSecurityGroupMemberships"
    )
    vpc_security_group_memberships: VpcSecurityGroupIdList = pydantic.Field(
        None, alias="VpcSecurityGroupMemberships"
    )
...
class OptionGroup(_RDSBase):
    ...
    allows_vpc_and_non_vpc_instance_memberships: Boolean = pydantic.Field(
        None, alias="AllowsVpcAndNonVpcInstanceMemberships"
    )
    vpc_id: String = pydantic.Field(None, alias="VpcId")
...
class OptionGroupOption(_RDSBase):
    ...
    engine_name: String = pydantic.Field(None, alias="EngineName")
    major_engine_version: String = pydantic.Field(None, alias="MajorEngineVersion")
    minimum_required_minor_engine_version: String = pydantic.Field(
        None, alias="MinimumRequiredMinorEngineVersion"
    )
    ...
    options_depended_on: OptionsDependedOn = pydantic.Field(
        None, alias="OptionsDependedOn"
    )
    options_conflicts_with: OptionsConflictsWith = pydantic.Field(
        None, alias="OptionsConflictsWith"
    )
    persistent: Boolean = pydantic.Field(None, alias="Persistent")
    permanent: Boolean = pydantic.Field(None, alias="Permanent")
    requires_auto_minor_engine_version_upgrade: Boolean = pydantic.Field(
        None, alias="RequiresAutoMinorEngineVersionUpgrade"
    )
    vpc_only: Boolean = pydantic.Field(None, alias="VpcOnly")
    supports_option_version_downgrade: BooleanOptional = pydantic.Field(
        None, alias="SupportsOptionVersionDowngrade"
    )
    option_group_option_settings: OptionGroupOptionSettingsList = pydantic.Field(
        None, alias="OptionGroupOptionSettings"
    )
    option_group_option_versions: OptionGroupOptionVersionsList = pydantic.Field(
        None, alias="OptionGroupOptionVersions"
    )
    copyable_cross_account: BooleanOptional = pydantic.Field(
        None, alias="CopyableCrossAccount"
    )
...
class OptionGroupOptionSetting(_RDSBase):
    ...
    minimum_engine_version_per_allowed_value: MinimumEngineVersionPerAllowedValueList = pydantic.Field(
        None, alias="MinimumEngineVersionPerAllowedValue"
    )


class OptionGroupOptionsMessage(_RDSBase):
    option_group_options: OptionGroupOptionsList = pydantic.Field(
        None, alias="OptionGroupOptions"
    )
    marker: String = pydantic.Field(None, alias="Marker")


class OptionGroups(_RDSBase):
    option_groups_list: OptionGroupsList = pydantic.Field(
...
class OrderableDBInstanceOption(_RDSBase):
    ...
    supports_storage_encryption: Boolean = pydantic.Field(
        None, alias="SupportsStorageEncryption"
    )
    storage_type: String = pydantic.Field(None, alias="StorageType")
    supports_iops: Boolean = pydantic.Field(None, alias="SupportsIops")
    supports_enhanced_monitoring: Boolean = pydantic.Field(
        None, alias="SupportsEnhancedMonitoring"
    )
    supports_iam_database_authentication: Boolean = pydantic.Field(
        None, alias="SupportsIAMDatabaseAuthentication"
    )
    supports_performance_insights: Boolean = pydantic.Field(
        None, alias="SupportsPerformanceInsights"
    )
    ...
    min_iops_per_db_instance: IntegerOptional = pydantic.Field(
        None, alias="MinIopsPerDbInstance"
    )
    max_iops_per_db_instance: IntegerOptional = pydantic.Field(
        None, alias="MaxIopsPerDbInstance"
    )
    ...
    available_processor_features: AvailableProcessorFeatureList = pydantic.Field(
        None, alias="AvailableProcessorFeatures"
    )
    supported_engine_modes: EngineModeList = pydantic.Field(
        None, alias="SupportedEngineModes"
    )
    supports_storage_autoscaling: BooleanOptional = pydantic.Field(
        None, alias="SupportsStorageAutoscaling"
    )
    supports_kerberos_authentication: BooleanOptional = pydantic.Field(
        None, alias="SupportsKerberosAuthentication"
    )
    outpost_capable: Boolean = pydantic.Field(None, alias="OutpostCapable")
    supported_activity_stream_modes: ActivityStreamModeList = pydantic.Field(
        None, alias="SupportedActivityStreamModes"
    )
    supports_global_databases: Boolean = pydantic.Field(
        None, alias="SupportsGlobalDatabases"
    )
    ...
    supports_storage_throughput: Boolean = pydantic.Field(
        None, alias="SupportsStorageThroughput"
    )
    min_storage_throughput_per_db_instance: IntegerOptional = pydantic.Field(
        None, alias="MinStorageThroughputPerDbInstance"
    )
    max_storage_throughput_per_db_instance: IntegerOptional = pydantic.Field(
        None, alias="MaxStorageThroughputPerDbInstance"
    )
    min_storage_throughput_per_iops: DoubleOptional = pydantic.Field(
        None, alias="MinStorageThroughputPerIops"
    )
    max_storage_throughput_per_iops: DoubleOptional = pydantic.Field(
        None, alias="MaxStorageThroughputPerIops"
    )


class OrderableDBInstanceOptionsMessage(_RDSBase):
    orderable_db_instance_options: OrderableDBInstanceOptionsList = pydantic.Field(
        None, alias="OrderableDBInstanceOptions"
    )
    marker: String = pydantic.Field(None, alias="Marker")
...
class PendingMaintenanceAction(_RDSBase):
    ...
    auto_applied_after_date: "TStamp" = pydantic.Field(
        None, alias="AutoAppliedAfterDate"
    )
...
class PendingMaintenanceActionsMessage(_RDSBase):
    pending_maintenance_actions: PendingMaintenanceActions = pydantic.Field(
...
class PurchaseReservedDBInstancesOfferingResult(_RDSBase):
    reserved_db_instance: "ReservedDBInstance" = pydantic.Field(
...
class RecurringCharge(_RDSBase):
    recurring_charge_amount: Double = pydantic.Field(
        None, alias="RecurringChargeAmount"
    )
    recurring_charge_frequency: String = pydantic.Field(
        None, alias="RecurringChargeFrequency"
    )
...
class ReservedDBInstance(_RDSBase):
    ...
    recurring_charges: RecurringChargeList = pydantic.Field(
        None, alias="RecurringCharges"
    )
    reserved_db_instance_arn: String = pydantic.Field(
        None, alias="ReservedDBInstanceArn"
    )
    lease_id: String = pydantic.Field(None, alias="LeaseId")
...
class ReservedDBInstanceMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    reserved_db_instances: ReservedDBInstanceList = pydantic.Field(
        None, alias="ReservedDBInstances"
    )
...
class ReservedDBInstancesOfferingMessage(_RDSBase):
    marker: String = pydantic.Field(None, alias="Marker")
    reserved_db_instances_offerings: ReservedDBInstancesOfferingList = pydantic.Field(
        None, alias="ReservedDBInstancesOfferings"
    )
...
class ResourcePendingMaintenanceActions(_RDSBase):
    ...
    pending_maintenance_action_details: PendingMaintenanceActionDetails = (
        pydantic.Field(None, alias="PendingMaintenanceActionDetails")
    )
...
class RestoreDBClusterToPointInTimeMessage(_RDSBase):
    ...
    use_latest_restorable_time: Boolean = pydantic.Field(
...
class RestoreDBInstanceToPointInTimeMessage(_RDSBase):
    ...
    source_db_instance_automated_backups_arn: String = pydantic.Field(
...
class ScalingConfiguration(_RDSBase):
    ...
    seconds_until_auto_pause: IntegerOptional = pydantic.Field(
        None, alias="SecondsUntilAutoPause"
    )
    timeout_action: String = pydantic.Field(None, alias="TimeoutAction")
    seconds_before_timeout: IntegerOptional = pydantic.Field(
        None, alias="SecondsBeforeTimeout"
...
class SourceRegion(_RDSBase):
    ...
    endpoint: String = pydantic.Field(None, alias="Endpoint")
    status: String = pydantic.Field(None, alias="Status")
    supports_db_instance_automated_backups_replication: Boolean = pydantic.Field(
        None, alias="SupportsDBInstanceAutomatedBackupsReplication"
    )
...
class Subnet(_RDSBase):
    ...
    subnet_availability_zone: "AvailabilityZone" = pydantic.Field(
        None, alias="SubnetAvailabilityZone"
    )
...
class SwitchoverBlueGreenDeploymentRequest(_RDSBase):
    ...
    switchover_timeout: SwitchoverTimeout = pydantic.Field(
...
class UpgradeTarget(_RDSBase):
    ...
    is_major_version_upgrade: Boolean = pydantic.Field(
        None, alias="IsMajorVersionUpgrade"
    )
    supported_engine_modes: EngineModeList = pydantic.Field(
        None, alias="SupportedEngineModes"
    )
    supports_parallel_query: BooleanOptional = pydantic.Field(
        None, alias="SupportsParallelQuery"
    )
    supports_global_databases: BooleanOptional = pydantic.Field(
        None, alias="SupportsGlobalDatabases"
    )
    supports_babelfish: BooleanOptional = pydantic.Field(
        None, alias="SupportsBabelfish"
    )
...
class UserAuthConfig(_RDSBase):
    ...
    client_password_auth_type: ClientPasswordAuthType = pydantic.Field(
...
class ValidDBInstanceModificationsMessage(_RDSBase):
    ...
    valid_processor_features: AvailableProcessorFeatureList = pydantic.Field(
        None, alias="ValidProcessorFeatures"
    )
...
class ValidStorageOptions(_RDSBase):
    ...
    iops_to_storage_ratio: DoubleRangeList = pydantic.Field(
        None, alias="IopsToStorageRatio"
    )
    supports_storage_autoscaling: Boolean = pydantic.Field(
        None, alias="SupportsStorageAutoscaling"
    )
    provisioned_storage_throughput: RangeList = pydantic.Field(
        None, alias="ProvisionedStorageThroughput"
    )
    storage_throughput_to_iops_ratio: DoubleRangeList = pydantic.Field(
        None, alias="StorageThroughputToIopsRatio"
    )
